...
<body data-type="widgets">
    ...
    <div class="am-g tpl-g">
                ...
                <@shiro.hasRole name="admin">
                    <li class="sidebar-nav-link">
                        ...
                        <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                            <li class="sidebar-nav-link">
                                <a href="${basePath}/admin/enterManage" class="sub-active">
        ...
        <#-- 添加，编辑企业窗口 -->
        <div class="am-modal am-modal-no-btn" tabindex="-1" id="enter-add-edit-modal">
            <div class="am-modal-dialog widget" style="width: 35%;">
                <div class="am-modal-hd" style="border-bottom: 1px solid #b571a6;">企业信息
                        ...
                        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                            <div class="widget am-cf">
                                <div class="widget-body am-fr">
                                    ...
                                    <form id="enterForm" class="am-form tpl-form-border-form tpl-form-border-br" data-am-validator>
                                        ...
                                        <div class="am-form-group">
                                            ...
                                            <div class="am-u-sm-9">
                                                <input type="text" class="tpl-form-input" id="address" name="address" placeholder="请输入企业地址" required>
                                            </div>
                                        </div>
                                        ...
                                        <#--<div class="am-form-group">-->
                                            <#--<div class="am-u-sm-9 am-u-sm-push-3">-->
                                                <#--<button type="button" class="am-btn am-btn-primary tpl-btn-bg-color-success " id="ADDENTER">注册</button>-->
                                            <#--</div>-->
                                        <#--</div>-->
                                        ...
                                        <div class="am-form-group">
                                            <div class="am-u-sm-9 am-u-sm-push-3">
                                                <button type="button" class="am-btn am-btn-primary tpl-btn-bg-color-success " id="ADDENTER">注册</button>
                                                <button type="button" class="am-btn am-btn-primary tpl-btn-bg-color-success " id="EDITENTER">修改</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" class="am-btn am-btn-default am-btn-success"  onclick="addModal()"><span class="am-icon-plus"></span> 添加企业</button>
                                ...
                                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3" style="float: right;">
                                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                        ...
                                        <span class="am-input-group-btn">
                                            <button id="SEARCHENTER" class="am-btn  am-btn-default am-btn-success tpl-table-list-field am-icon-search" type="button"></button>
                                        </span>
                                    </div>
                                </div>
    ...
    <script src="${basePath}/statics/my/page-js/enterManage.js"></script>
