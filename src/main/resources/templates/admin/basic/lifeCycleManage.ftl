...
<head>
    ...
    <#--treetable-->
    <link rel="stylesheet" href="${basePath}/statics/plugin/treetable/jquery.treetable.css">
    <link rel="stylesheet" href="${basePath}/statics/plugin/treetable/jquery.treetable.theme.default.css">
...
<div class="am-g tpl-g">
            ...
            <@shiro.hasRole name="admin">
                <li class="sidebar-nav-link">
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                        ...
                        <li class="sidebar-nav-link">
                            <a href="${basePath}/admin/lifeCycleManage"   class="sub-active">
                        ...
                        <div class="widget-body  am-fr">
                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <button type="button" class="am-btn am-btn-default am-btn-success" id="BTN_ADD_LifeCycle">
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3" style="float: right;">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    <input type="text" class="am-form-field " id="SEARCH_NAME" name="searchName" placeholder="请输入生命周期名称">
                            ...
                            <div class="am-u-sm-12">
                                <#--am-table am-table-compact am-table-bordered tpl-table-black-->
                                <#--table table-bordered table-advance-->
                                <table class="am-table am-table-compact am-table-bordered tpl-table-black" id="LifeCycle_Table">
                                    <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">生命周期介绍</th>
                                        <th style="text-align: center;">操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="LifeCycle_TABLE_BODY">
                                        <#--<tr data-tt-id="id1">-->
                                            <#--<td>-->
                                                <#--<input type="checkbox" name="selectAll" id="CKBOX_SELECT_ALL">-->
                                            <#--</td>-->
                                        ...
                                        <#--<tr data-tt-id="id2" >-->
                                            ...
                                            <#--<td>2</td>-->
                                        <#--</tr>-->
                                        <#--<tr data-tt-id="id3" data-tt-parent-id="id1">-->
                                            <#--<td>-->
                                                <#--<input type="checkbox" name="selectAll" id="CKBOX_SELECT_ALL">-->
                                            <#--</td>-->
                                            <#--<td>3</td>-->
                                            ...
                                            <#--<td>3</td>-->
                                        <#--</tr>-->
                                        <#--<tr data-tt-id="id4" data-tt-parent-id="id2">-->
                                            <#--<td>-->
                                                <#--<input type="checkbox" name="selectAll" id="CKBOX_SELECT_ALL">-->
                                            <#--</td>-->
                                            <#--<td>4</td>-->
    ...
    <#--添加-->
    <div id="ADD_LifeCycle_DIV" style="display: none" class="widget" >
        <form class="am-form tpl-form-border-form tpl-form-border-br" id="ADD_LifeCycle_FORM" data-am-validator>
            <div class="am-form-group">
                <label for="user-name" class="am-u-sm-3 am-form-label"> 生命周期名称</label>
                <div class="am-u-sm-9">
                    <input type="text" class="tpl-form-input" id="LifeCycle_NAME" name="name" placeholder="请输入生命周期名称" required>
                </div>
            </div>
            <div class="am-form-group">
                <label for="user-phone" class="am-u-sm-3 am-form-label"> 所属生命周期</label>
                <div class="am-u-sm-9">
                    <select data-am-selected="{searchBox: 1}" style="display: none;" id="ADD_LifeCycle_SELECT">
                    </select>
                </div>
            </div>
            <div class="am-form-group">
                <label for="user-intro" class="am-u-sm-3 am-form-label">生命周期介绍</label>
                <div class="am-u-sm-9">
                    <textarea class="" rows="10" placeholder="请输入生命周期介绍" id="LifeCycle_INTRODUCE" name="introduce"></textarea>
                </div>
            </div>
        </form>
    </div>
    ...
    <script src="${basePath}/statics/plugin/treetable/jquery.treetable.js"></script>
    <script src="${basePath}/statics/my/page-js/lifeCycleManage.js"></script>
