...
<div class="am-g tpl-g">
                        ...
                        <div class="widget-body  am-fr">
                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <button type="button" class="am-btn am-btn-default am-btn-success" id="BTN_ADD_UNIT">
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3" style="float: right;">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    <input type="text" class="am-form-field " id="SEARCH_NAME" name="searchName" placeholder="请输入量纲名称">
                            ...
                            <div class="am-u-sm-12">
                                <table width="100%" class="am-table am-table-compact am-table-bordered tpl-table-black " >
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center;">量纲名称</th>
                                        <th style="text-align: center;">量纲介绍</th>
                                        <th style="text-align: center;">操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="UNIT_TABLE_BODY"></tbody>
                                </table>
                            </div>
    ...
    <#--添加-->
    <div id="ADD_UNIT_DIV" style="display: none" class="widget" >
        <form class="am-form tpl-form-border-form tpl-form-border-br" id="ADD_UNIT_FORM" data-am-validator>
            <div class="am-form-group">
                <label for="user-name" class="am-u-sm-3 am-form-label"> 量纲名称</label>
                <div class="am-u-sm-9">
                    <input type="text" class="tpl-form-input" id="UNIT_NAME" name="name" placeholder="请输入量纲名称" required>
                </div>
            </div>

            <div class="am-form-group">
                <label for="user-intro" class="am-u-sm-3 am-form-label">量纲介绍</label>
                <div class="am-u-sm-9">
                    <textarea class="" rows="10" placeholder="请输入量纲介绍" id="UNIT_INTRODUCE" name="remark"></textarea>
                </div>
            </div>
        </form>
    </div>
    ...
    <script src="${basePath}/statics/my/page-js/unitManage.js"></script>
