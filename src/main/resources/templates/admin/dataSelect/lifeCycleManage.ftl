                ...
                <@shiro.hasRole name="admin">
                    ...
                    <li class="sidebar-nav-link">
                        ...
                        <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                            <li class="sidebar-nav-link">
                                <a href="${basePath}/dataSelect/lifeCycleManage" class="active">
                            ...
                            <div class="widget-body  am-fr">
                                ...
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-compact am-table-bordered tpl-table-black " >
                                        <thead>
                                            <tr>
                                                <th style="text-align: center;"><input type="checkbox" name="lifeCycleCheckboxs"></th>
                                                <th style="text-align: center;">序号</th>
                                                <th style="text-align: center;">生命周期编号</th>
                                                <th style="text-align: center;">生命周期名称</th>
                                                <th style="text-align: center;">生命周期描述</th>
                                        ...
                                        <tbody id="otherTableTbody">
                                            <tr>
                                                <td style="text-align: center;"><input type="checkbox" name="lifeCycleCheckbox"></td>
                                                <td style="text-align: center;">1</td>
                                                <td style="text-align: center;">SJK</td>
                                                <td style="text-align: center;">生产阶段</td>
                                                <td style="text-align: center;">用作生产</td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">回收阶段</td>
                                                <td style="text-align: center;">用作回收</td>
                                                <td style="text-align: center;"><button class="am-btn am-btn-danger am-btn-xs" type="button">删除</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="am-u-lg-12 am-cf">
                                    <p id="TOTAL" class="am-fr" style="padding-left: 2%;margin: 1.5rem 0;float: left;">第 <span id="start">1</span> 到 <span id="end">2</span> 条记录，共 <span id="totalNum">2</span> 条</p>
                                    <div class="am-fr">
