...
<div class="am-g tpl-g">
            ...
            <@shiro.hasRole name="admin">
                ...
                <li class="sidebar-nav-link">
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                        <li class="sidebar-nav-link">
                            <a href="${basePath}/user/accountManage" class="active">
                        ...
                        <div class="widget-body  am-fr">
                            ...
                            <div class="am-u-sm-12">
                                ...
                                <table id="User_Table"></table>
                                    ...
                                    <thead>
                                        <tr>
                                            <th style="text-align: center;"><input type="checkbox" name="userCheckboxs"></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="text-align: center;"><input type='checkbox' name='userCheckbox' ></td>
                                            <td style="text-align: center;">1</td>
                                            <td style="text-align: center;">174171</td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">174172</td>
    ...
    <script>
        ...
        function operateFormatter(value, row, index) {
            ...
            var html = "<button class=\"am-btn am-btn-secondary am-btn-xs\" type='button' onclick='enabled("+ value +")'>禁用账户</button>"+
                        "<button class=\"am-btn am-btn-success am-btn-xs\" type='button' onclick='reset("+ value +")'>重置密码</button>"+
                        "<button class=\"am-btn am-btn-danger am-btn-xs\" type='button' onclick='del ("+ value +")'>删除</button>";
            return html;
        }
