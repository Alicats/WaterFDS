...
<body data-type="widgets">
                    ...
                    <li class="sidebar-nav-link">
                        ...
                        <@shiro.hasRole name="admin">
                            <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                                <li class="sidebar-nav-link">
                                    <a href="${basePath}/admin/enterpriseManage" class="sub-active">
                        ...
                        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                            <div class="widget am-cf">
                                <div class="widget-body am-fr">
                                    ...
                                    <form id="enterpriseForm" class="am-form tpl-form-border-form tpl-form-border-br" data-am-validator>
                                        ...
                                        <div class="am-form-group">
                                            <label for="enterId" class="am-u-sm-3 am-form-label">所属企业</label>
                                            <div class="am-u-sm-7">
                                                <select data-am-selected="{searchBox: 1}" style="display: none;" id="optionEnters">
                                                </select>
                            ...
                            <div class="widget-body  am-fr">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" class="am-btn am-btn-default am-btn-success" onclick="addModal()"><span class="am-icon-plus"></span> 添加负责人</button>
                                ...
                                <div class="am-u-sm-12 am-u-md-12 am-u-lg-3" style="float: right;">
                                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                        <input type="text" class="am-form-field" id="USER_SEARCH" placeholder="请输入负责人名称">
                                ...
                                <div class="am-u-lg-12 am-cf">
                                    <#--<p class="am-fr" style="padding-left: 2%;color: white;margin: 1.5rem 0;float: left;">总数量: <span id="totalNum"></span></p>-->
    ...
    <script src="${basePath}/statics/my/page-js/enterpriseManage.js"></script>
