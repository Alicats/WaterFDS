...
<div class="am-g tpl-g">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-link">
                ...
                <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                    <@shiro.hasAnyRoles name="admin,enterprise">
                        <li class="sidebar-nav-link">
                            <a href="${basePath}/productTypeManage" class="sub-active">
    ...
    <#-- 添加,编辑产品类型窗口 -->
    <div class="am-modal am-modal-no-btn" tabindex="-1" id="productType-add-edit-modal">
        <div class="am-modal-dialog widget" style="width: 35%;">
            <div class="am-modal-hd" style="border-bottom: 1px solid #b571a6;">产品类型信息
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-body am-fr">
                                ...
                                <form id="productTypeForm" class="am-form tpl-form-border-form tpl-form-border-br" data-am-validator>

                                    <div class="am-form-group">
                                        <label for="name" class="am-u-sm-3 am-form-label">产品类型名称</label>
                                        <div class="am-u-sm-7">
                                            <input type="text" class="tpl-form-input" id="name" name="name" placeholder="请输入产品类型名称" required>
                                        </div>
                                        <div class="am-u-sm-2">
                                    ...
                                    <div class="am-form-group">
                                        <label for="introduce" class="am-u-sm-3 am-form-label">产品类型描述</label>
                                        <div class="am-u-sm-7">
                                            <input type="text" class="tpl-form-input" id="introduce" name="introduce" placeholder="请输入产品类型描述" >
                                        </div>
                                        <div class="am-u-sm-2">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-sm-push-3">
                                            <button type="button" class="am-btn am-btn-primary tpl-btn-bg-color-success " id="ADD_ProductType">添加</button>
                                            <button type="button" class="am-btn am-btn-primary tpl-btn-bg-color-success " id="EDIT_ProductType">修改</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="widget-body  am-fr">
                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <button type="button" class="am-btn am-btn-default am-btn-success" onclick="addModal()"><span class="am-icon-plus"></span> 添加产品类型</button>
                                            <button type="button" id="delAllProductType" class="am-btn am-btn-default am-btn-danger"><span class="am-icon-trash-o"></span> 批量删除</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3" style="float: right;">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    <input type="text" class="am-form-field" id="ProductType_SEARCH" placeholder="请输入产品类型名称">
                                    <span class="am-input-group-btn">
                                        <button id="SEARCH_ProductType" class="am-btn  am-btn-default am-btn-success tpl-table-list-field am-icon-search" type="button"></button>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="am-u-sm-12">
                                <table width="100%" class="am-table am-table-compact am-table-bordered tpl-table-black " >
                                    <thead>
                                    <tr>
                                        <th style="text-align: center;"><input type="checkbox" name="productTypeCheckboxs"></th>
                                        <th style="text-align: center;">序号</th>
                                        <th style="text-align: center;">产品类型编号</th>
                                        <th style="text-align: center;">产品类型名称</th>
                                        <th style="text-align: center;">产品类型描述</th>
                                        <th style="text-align: center;">产品类型备注</th>
                                        <th style="text-align: center;">操作</th>
                                    </tr>
                                    </thead>

                                    <tbody id="productTypeTableTbody">
...
<script src="${basePath}/statics/my/page-js/productTypeManage.js"></script>
