...
<div class="am-g tpl-g">
                ...
                <li class="sidebar-nav-link">
                    ...
                    <@shiro.hasRole name="enterprise">
                        <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                            ...
                            <li class="sidebar-nav-link">
                                <a href="${basePath}/enterprise/collaboratorManage" class="sub-active">
    ...
    <div class="am-modal am-modal-no-btn" tabindex="-1" id="user-add-edit-modal">
        <div class="am-modal-dialog widget" style="width: 35%;">
            <div class="am-modal-hd" style="border-bottom: 1px solid #b571a6;">内部协作人信息
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-body am-fr">
                                ...
                                <form id="collaboratorForm" class="am-form tpl-form-border-form tpl-form-border-br" data-am-validator>
                        ...
                        <div class="widget-body  am-fr">
                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <button type="button" class="am-btn am-btn-default am-btn-success" onclick="addModal()"><span class="am-icon-plus"></span> 添加内部协作人</button>
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3" style="float: right;">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    <input type="text" class="am-form-field" id="USER_SEARCH" placeholder="请输入内部协作人名称">
                            ...
                            <div class="am-u-sm-12">
                                <table width="100%" class="am-table am-table-compact am-table-bordered tpl-table-black " >
                                    ...
                                    <tbody id="collaboratorTableTbody">
...
<script src="${basePath}/statics/my/page-js/collaboratorManage.js"></script>
